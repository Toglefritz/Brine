...
void main() {
  ...
  group('ErrorResponse', () {
    ...
    group('toJson', () {
      /// This test verifies that the `toJson` method successfully converts an [ErrorResponse] object to a JSON-serializable map.
      test(
          'should successfully convert an ErrorResponse object to a JSON-serializable map',
          () {
