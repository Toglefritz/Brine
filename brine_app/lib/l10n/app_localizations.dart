...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to: **'Battery Level'**
  String get batteryLevel;

  /// Text displayed while the app is establishing a Bluetooth connection to a device.
  ///
  /// In en, this message translates to: **'Establishing connection...'**
  ...
  ///
  /// In en, this message translates to: **'We had a bit of trouble connecting to your Brine device over Bluetooth. Make
  /// sure it\'s powered on, nearby, and ready to pair, then give it another try.'**
  ...
  ///
  /// In en, this message translates to: **'Bluetooth permissions are required to set up your Brine device. Once your
  /// Brine device is ready to go, feel free to switch it off again if you prefer.'**
  ...
  ///
  /// In en, this message translates to: **'Bluetooth Permissions Required'**
  ...
  ///
  /// In en, this message translates to: **'Device detected'**
  ...
  ///
  /// In en, this message translates to: **'We\'ve sent a confirmation email to {email}. Please click the link in the
  ...
  ///
  /// In en, this message translates to: **'Confirmation required'**
  String get emailUpdateDialogTitle;

  /// No description provided for @firebaseAuthCreationError.
  ///
  /// In en, this message translates to: **'Something went wrong while setting up your login credentials. This could be
  /// due to a network hiccup, an issue with the email or password, or just some temporary turbulence. Just give it
  /// another go, and if the problem sticks around, our team is here to help and they have, in fact, already been
  /// alerted.'**
  ...
  ///
  /// In en, this message translates to: **' before using this app.'**
  ...
  ///
  /// In en, this message translates to: **'Password is required'**
  String get passwordRequired;

  /// Error message displayed when the user enters a password that is too short.
  ///
  /// In en, this message translates to: **'Password is too short (minimum 8 characters)'**
  String get passwordTooShort;

  /// Error message displayed when the app fails to update the user's password.
  ///
  /// In en, this message translates to: **'Failed to update password'**
  String get passwordUpdateFailed;

  /// Text displayed while the app is performing the security setup process.
  ///
  /// In en, this message translates to: **'Performing security setup...'**
  ...
  ///
  /// In en, this message translates to: **'terms of service'**
  ...
  ///
  /// In en, this message translates to: **'Your session has expired. Please log in again.'**
  String get unauthenticatedError;

  /// Title for the error message displayed when the user's session has expired.
  ///
  /// In en, this message translates to: **'Authentication Error'**
  String get unauthenticatedErrorTitle;

  /// Error message displayed when an unknown error occurs.
  ///
  /// In en, this message translates to: **'Yikes! A mysterious glitch just occurred. The Brine team has been alerted
  /// and will get things sorted out ASAP. Thanks for your patience!'**
  String get unknownError;

  /// No description provided for @unknownErrorTitle.
  ///
  /// In en, this message translates to: **'Oh no!'**
  String get unknownErrorTitle;

  /// Label for the field where the user must enter their username.
  ///
  /// In en, this message translates to: **'Username (email)'**
  String get username;

  /// Error message displayed when the app fails to create a user document in Firestore.
  ///
  /// In en, this message translates to: **'Your account was created, but we couldn’t finish setting up your profile
  /// behind the scenes. This is likely a temporary issue, and the Brine team has already been alerted. You can try
  /// again in a moment, and we’ll make sure everything’s running smoothly.'**
