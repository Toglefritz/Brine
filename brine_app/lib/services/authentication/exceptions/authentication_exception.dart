...
///
/// Callers can catch this exception and implement custom logic, such as redirecting the user to the login screen
/// or prompting them to refresh their authentication token.
