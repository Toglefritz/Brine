...
/// A class representing a response confirming that the Brine device has successfully received and saved the pre-shared
/// key (PSK) to non-volatile storage (NVS).
