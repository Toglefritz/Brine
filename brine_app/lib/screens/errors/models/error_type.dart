...
///
/// This enumeration is used to categorize errors and provide specific error handling or user feedback based on the type
/// of error encountered. The errors in this enum span the entire app. Each error is associated with a specific set of
/// troubleshooting steps or user actions that can be taken to resolve the issue.
enum ErrorType {
