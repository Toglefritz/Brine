...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'Three AA batteries power Brine for up to a year.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'The level of salt in your water softener is down to only'**
  ...
  ///
  /// In en, this message translates to:
  /// **'That\'s quite enough confetti for you, sir.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Never forget to fill your water softener with salt'**
  ...
  ///
  /// In en, this message translates to:
  /// **'The Brine monitor mounts inside your water softener.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Sensors detect the level of salt in your water softener and report the level.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Want to share Brine with your friends?'**
