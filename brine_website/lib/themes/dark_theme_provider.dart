...
/// [DarkThemeProvider] is a [ChangeNotifier] that manages the state of the application's theme mode. It is meant to
/// be used with the [Provider] package to propagate the theme state changes to the widgets that depend on it.
///
/// The class uses an instance of [DarkThemePreference] to access and modify the persistent dark theme preference.
class DarkThemeProvider with ChangeNotifier {
  /// Constructor for [DarkThemeProvider]. It initializes the dark theme preference by calling the
  /// [DarkThemePreference] instance's `getTheme` method.
